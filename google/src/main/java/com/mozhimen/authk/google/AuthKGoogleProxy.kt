...
class AuthKGoogleProxy constructor(private var _componentActivity: ComponentActivity?, private val _serverClientId: String) : BaseWakeBefDestroyLifecycleObserver() {
